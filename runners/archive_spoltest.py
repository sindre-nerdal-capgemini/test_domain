...
class ArchiveSpoltest(Spoltest):
    def __init__(self, domain, request_in_parallel, test_request_count_after_cached, should_follow_redirects, dom_meta_file, timeout_between_each_chunk, output_dir):
        super().__init__(domain, request_in_parallel, test_request_count_after_cached, should_follow_redirects, dom_meta_file, timeout_between_each_chunk)
